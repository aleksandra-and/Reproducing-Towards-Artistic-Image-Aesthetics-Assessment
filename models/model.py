...
class SAB(nn.Module):
    ...
    def _init_weights(self):
        self.model.load_state_dict(torch.load('checkpoint/ResNet_Pretrain/epoch_99.pth', map_location='cuda:0'), strict=False)
        #self.model.load_state_dict(torch.load('checkpoint/BAID/model_best.pth'), strict=False)
